...
if (move_uploaded_file($ImagemTemp, $caminhoImagem)) {
    ...
    $inserir = mysqli_query($conn,"INSERT INTO sos_kids (nome, idade, sexo, lugar, nome_pais, nome_user, imagem) VALUES ('$Nome','$Idade','$Sexo','$Lugar','$Pais','$User','$caminhoImagem')");
