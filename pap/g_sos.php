...
<body>
    <div class="card">
        <div class="card-content">
            ...
            if ($conn) {
                // Consultar a última criança cadastrada na tabela "sos_kids"
                $query = "SELECT * FROM sos_kids ORDER BY id DESC LIMIT 1";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<h1 class='card-title'>Criança cadastrada no Abrigo SOS</h1>";
                    ...
                    echo "Nenhuma criança cadastrada.";
                }
